...
from gainz.db.dependencies import get_db_session
from gainz.db.utils import create_database, drop_database
from gainz.services.rabbit.dependencies import get_rmq_channel_pool
from gainz.services.rabbit.lifespan import init_rabbit, shutdown_rabbit
from gainz.services.redis.dependency import get_redis_pool
from gainz.settings import settings
from gainz.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    from gainz.db.models import load_all_models
